package com.example.multi_lang.config;

import com.example.multi_lang.entity.Role;
import com.example.multi_lang.security.JwtAuthenticationFilter;
...
public class SecurityConfiguration {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        source.registerCorsConfiguration("/swagger-ui/**", configuration); // Swagger UI requests
